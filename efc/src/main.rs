use efc::bls_verifier::test_bls_verify;
// use std::env;
...
// use efc::zkcuda_permutation::test_zkcuda_permutation_indices_validator_hashes;
...
fn main() {
    ...
    //test_zkcuda_shuffle();
    //test_zkcuda_permutation_indices_validator_hashes();
